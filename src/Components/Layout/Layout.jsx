...
const Layout = ({ children, pageName }) => {
  ...
  return (
    <div className="layout h-screen overflow-hidden flex w-full ">
      <Sidebar pageName={pageName} isSideBarHidden={isSideBarHidden}/>
      <div className="flex flex-col gap-[20px] w-full h-screen">
        <UserInfoLine  isSideBarHidden={isSideBarHidden} setIsSideBarHidden={setIsSideBarHidden} screenWidth={screenWidth}/>
